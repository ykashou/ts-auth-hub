...
import { Loader2, Save, RotateCcw, Globe, GripVertical, ArrowLeft, Undo2, Redo2, Monitor, Smartphone, Tablet, Upload, Check, X, Palette, Settings, Image as ImageIcon } from "lucide-react";
