...
import { Shield, Boxes, Settings2, FileText, Code2, LogOut, Home, Users, ShieldCheck, ChevronDown, Globe, Layout, Palette } from "lucide-react";
...
export default function Navbar() {
  ...
  const serviceManagementItems = [
    ...
    { path: "/admin/login-editor", label: "Login Editor", icon: Palette, testId: "button-login-editor" },
